-- NewsFlow MySQL Database Initialization
-- This script creates the database schema for NewsFlow application

CREATE DATABASE IF NOT EXISTS newsflow;
USE newsflow;

-- Create user with proper permissions
CREATE USER IF NOT EXISTS 'newsflow_user'@'%' IDENTIFIED BY 'your_password';
